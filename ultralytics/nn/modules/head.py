...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect","GhostConv"
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.cv3 = nn.ModuleList(
            nn.Sequential(
                nn.Sequential(DWConv(x, x, 3), GhostConv(x, c3, 1)),
                nn.Sequential(DWConv(c3, c3, 3), GhostConv(c3, c3, 1)),
